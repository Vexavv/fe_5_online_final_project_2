            ...
            <div className={styles.CardDescriptionContainer}>
              <span
                className={
                  sale
                    ? classNames(
                        styles.CardDescriptionContainerSalePrice,
                        styles.CardDescriptionContainerPrice
                      )
                    : styles.CardDescriptionContainerPrice
                }
              >
              ...
              {sale && (
                <span className={styles.CardDescriptionContainerPrice2}>
                  ${currentPrice}.00
                </span>
              )}
            ...
            <div className={styles.RowDescriptionAll}>
              <span
                className={
                  sale
                    ? classNames(
                        styles.RowDescriptionAllPrice,
                        styles.RowDescriptionAllPrice2
                      )
                    : styles.RowDescriptionAllPrice
                }
              >
              ...
              {sale && (
                <span className={styles.RowDescriptionAllSalePrice}>
                  ${currentPrice}.00
                </span>
              )}
            </div>
